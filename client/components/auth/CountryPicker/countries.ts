...
export const countries: Country[] = [
  ...
  { code: "BV", dialCode: "+47", name: "Bouvet Island" },
  { code: "BR", dialCode: "+55", name: "Brazil" },
  { code: "IO", dialCode: "+246", name: "British Indian Ocean Territory" },
  { code: "VG", dialCode: "+1284", name: "British Virgin Islands" },
  ...
  { code: "BQ", dialCode: "+599", name: "Caribbean Netherlands" },
  ...
  { code: "TF", dialCode: "+262", name: "French Southern and Antarctic Lands" },
  ...
  { code: "MP", dialCode: "+1670", name: "Northern Mariana Islands" },
  ...
  { code: "PN", dialCode: "+64", name: "Pitcairn Islands" },
  ...
  { code: "SH", dialCode: "+2", name: "Saint Helena, Ascension and Tristan da Cunha" },
  ...
  { code: "SX", dialCode: "+1721", name: "Sint Maarten" },
  ...
  { code: "GS", dialCode: "+500", name: "South Georgia" },
  ...
  { code: "SJ", dialCode: "+4779", name: "Svalbard and Jan Mayen" },
  ...
  { code: "UM", dialCode: "+268", name: "United States Minor Outlying Islands" },
  { code: "VI", dialCode: "+1340", name: "United States Virgin Islands" },
  { code: "UY", dialCode: "+598", name: "Uruguay" },
  { code: "UZ", dialCode: "+998", name: "Uzbekistan" },
  { code: "VU", dialCode: "+678", name: "Vanuatu" },
  { code: "VA", dialCode: "+3", name: "Vatican City" },
  { code: "VE", dialCode: "+58", name: "Venezuela" },
  { code: "VN", dialCode: "+84", name: "Việt Nam" },
  { code: "WF", dialCode: "+681", name: "Wallis and Futuna" },
  { code: "EH", dialCode: "+2", name: "Western Sahara" },
  { code: "YE", dialCode: "+967", name: "Yemen" },
  { code: "ZM", dialCode: "+260", name: "Zambia" },
  { code: "ZW", dialCode: "+263", name: "Zimbabwe" },
  { code: "AX", dialCode: "+35818", name: "Åland Islands" },
];

export const defaultCountry = countries.find((country) => country.code === defaultCountryCode) ?? countries[0];
