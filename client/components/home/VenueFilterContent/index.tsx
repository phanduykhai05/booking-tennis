...
type VenueFilterContentProps = { showPromotion?: boolean };

export default function VenueFilterContent({ showPromotion = false }: VenueFilterContentProps) {
