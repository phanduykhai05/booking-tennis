...
export default function StarCard({ item }: StarCardProps) {
  return (
    <Link className="block shrink-0 basis-[150px]" href={item.href} rel="noopener noreferrer" target="_blank">
      <article className={`${styles.card} relative flex h-[180px] w-[150px] flex-col items-center rounded-2xl bg-[rgba(34,134,0,0.1)] p-3 text-center backdrop-blur transition-colors hover:bg-[rgba(34,134,0,0.25)]`}>
